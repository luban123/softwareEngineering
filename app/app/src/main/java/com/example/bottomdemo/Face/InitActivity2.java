...
public class InitActivity2 extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.face_activity_init2);
...
//    }
    ...
    public void jumpToFaceRecognizeActivity(View view) {
        checkLibraryAndJump(RegisterAndRecognizeActivity2.class);
    }
...
//    }
    ...
    public void activeEngine(final View view) {
        ...
        Observable.create(new ObservableOnSubscribe<Integer>() {
            ...
            public void subscribe(ObservableEmitter<Integer> emitter) {
                ...
                int activeCode = FaceEngine.activeOnline(InitActivity2.this, Constants.APP_ID, Constants.SDK_KEY);
                ...
                .subscribe(new Observer<Integer>() {
                    ...
                    public void onNext(Integer activeCode) {
                        ...
                        int res = FaceEngine.getActiveFileInfo(InitActivity2.this, activeFileInfo);
    ...
    void checkLibraryAndJump(Class activityClass) {
        ...
        Intent intent=new Intent(InitActivity2.this, activityClass);
